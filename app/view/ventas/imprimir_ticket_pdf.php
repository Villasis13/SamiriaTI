...
//Logo
//$pdf->Image(_SERVER_.'media/logo/logo_empresa.png',31.1,6, '17', '17', 'PNG');
$pdf->Ln(15);
...
$pdf->Cell(60,4,"El mejor alojamiento y servicio",0,1,'C');
...
foreach ($detalle_venta as $f){
    $pdf->SetFont('Helvetica', '', 7);
    $pdf->CellFitSpace(40,4,"[$f->venta_detalle_cantidad].$f->venta_detalle_nombre_producto",0,'');
    //$pdf->Cell(35, -5, "$f->venta_detalle_cantidad",0,0,'R');
    $pdf->Cell(8, '5', number_format(round("$f->venta_detalle_precio_unitario",2), 2, ',', ' '),0,0,'R');
...
$pdf->Ln(3);
$pdf->Cell(60,0,'bufeotec.com',0,1,'C');
