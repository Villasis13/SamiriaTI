<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 text-center font-weight-bold text-primary" style="color: #6a0c0d !important;">LISTA DE RESUMENES DIARIOS ENVIADAS</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <table class="table table-borderless table-striped table-earning" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        foreach ($resumen as $al){
                                            ...
                                            <tr <?= $stylee?>>
                                                ...
                                                <td>
                                                    <a id="btn_consultar<?= $al->id_envio_resumen;?>" type="button" title="Consultar Resumen Diario" class="btn btn-sm btn-success btne" style="color: white" onclick="preguntar('¿Está seguro que desea Consutar este Resumen Diario?','consultar_ticket_resumen', 'Si', 'No', <?= $al->id_envio_resumen;?>)"><i class="fa fa-cloud-download"></i></a>
