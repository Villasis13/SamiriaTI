                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div id="botonreceta<?= $m->id_receta;?>">
                                                    <button data-toggle="modal"  data-target="#editarDatosReceta" onclick="editar_receta(<?= $m->id_receta;?>,'<?= $m->id_usuario;?>','<?= $m->receta_nombre;?>','<?= $m->receta_estado;?>')" class="btn btn-info" ><i class="fa fa-pencil"></i></button>
                                                </div>
                                                <?php
                                                $validar_contenido = $this->receta->validar_contenido($m->id_receta);
                                                if(empty($validar_contenido)){
                                                    ?>
                                                    <button id="btn-eliminarreceta<?= $m->id_receta;?>" class="btn btn-danger" onclick="preguntar('¿Está seguro que desea eliminar esta receta?','eliminar_receta','Si','No',<?= $m->id_receta;?>)"><i class="fa fa-trash"></i></button>
                                                <?php
                                                }
                                                ?>
                                            </td>
