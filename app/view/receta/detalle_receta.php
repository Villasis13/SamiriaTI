...
<!--                                </div>-->
                            ...
                            <input type="hidden" id="valor_conversion" name="valor_conversion" value="0">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Unidad Medida</label>
                                        <select class="form-control" name="detalle_receta_unidad_medida" id="detalle_receta_unidad_medida">
                                            <?php
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly type="text" id="detalle_receta_precio" name="detalle_receta_precio" onkeyup="validar_numeros_decimales_dos(this.id)" placeholder="Precio calculado...">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                                    </div>-->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Unidad Medida</label>
                                        <select class="form-control" name="detalle_receta_unidad_medida_e" id="detalle_receta_unidad_medida_e">
                                            <?php
                                            foreach($unidad_medida as $um){
                                                ?>
                                ...
                                <table class="table table-borderless table-striped table-earning" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    foreach ($detalle_recetas as $m){
                                        ...
                                        <tr>
                                            ...
                                            <td id="detalle_recetaunidad<?= $m->id_detalle_receta;?>"><?= $m->medida_nombre;?></td>
                                            <td><?= $m->detalle_receta_precio;?></td>
                                            <!--<td <?=$estilo_estado;?> id="detalle_recetaestado<?= $m->id_detalle_receta?>"><?= $estado;?></td>-->
                                            <td>
                                                    <button data-toggle="modal" data-target="#editarDatosDetalle_receta" onclick="editar_detalle_receta(<?= $m->id_detalle_receta;?>,'<?= $m->id_receta;?>',<?= $m->id_recursos_sede;?>,'<?= $m->detalle_receta_unidad_medida;?>','<?= $m->detalle_receta_cantidad;?>','<?= $m->detalle_receta_precio;?>','<?= $m->detalle_receta_estado;?>')" class="btn btn-sm btn-info btn" ><i class="fa fa-pencil"></i></button>
