...
$printer->text("NOMBRE : ". $nombre_cliente . "\n");
$printer->text("Nª DOCUMENTO : ". $dni_cliente . "\n");
$printer->text("N° HABITACION:". $num_habitacion->habitacion_nro . "\n");
//$printer->text("FECHA DE ENVIO : ".date('d-m-Y',strtotime($fecha_hoy)) . "\n");
