    ...
    public function guardar_nuevo_detalle_receta(){
        ...
        try {
            ...
            if ($ok_data) {
                ...
                //aqui guardariamos el valor de la conversion y si no hay se guardaria lo ya habido
                $buscar_medida = $this->receta->buscar_medida($_POST['id_recursos_sede']);
                if($_POST['valor_conversion'] != 0){
                    $model->detalle_receta_unidad_medida = $_POST['valor_conversion'];
                }else{
                    $model->detalle_receta_unidad_medida = $_POST['detalle_receta_unidad_medida'];
                }
    ...
    public function guardar_edicion_detalle_receta(){
        ...
        try{
            ...
            if($ok_data){
                ...
                $model->detalle_receta_unidad_medida = $_POST['detalle_receta_unidad_medida_e'];
