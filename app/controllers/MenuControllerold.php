...
class MenuController{
    ...
    public function actualizar_cambio(){
        ...
        try {
            ...
            if ($ok_data) {
                //Creamos el modelo y ingresamos los datos a guardar
                /*                $first_com= "cd c:/laragon/www/ferreteria/";
                                $second_com= " git pull https://ElmoSabeDondeVives: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@github.com/bufeotec/ferreteria.git";
                                @exec($first_com." && ".$second_com);*/
                $command1 = "cd c:/xampp/htdocs/hotelsamira/";
                $command2 = "git pull -f https://JersonSolsol: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@github.com/bufeotec/samiriatec.git";

                // Corremos el primer comando
                $out1  = array();
                $code1 = 0;
                exec($command1, $out1, $code1);

                // corremos el segundo comando solo si el primero se ejecuto
                $out2  = array();
                $code2 = 0;
                if ($code1 == 0) {
