...
function guardar(){
    ...
    if(valor){
        ...
        "&id_medida=" + id_medida +
        "&recurso_sede_factor_unidad=" + recurso_sede_factor_unidad +
        "&recurso_sede_cantidad=" + recurso_sede_cantidad +
        "&recurso_sede_precio_unit=" + recurso_sede_precio_unit +
        "&recurso_sede_peso_inicial=" + recurso_sede_peso_inicial +
        "&recurso_sede_peso_final=" + recurso_sede_peso_final +
        "&recurso_sede_precio_total=" + recurso_sede_precio_total +
        "&recurso_sede_merma=" + recurso_sede_merma +
...
function editar_stock_entrante(id_recurso_sede,recurso_sede_precio){
    $('#id_recurso_sede_stock').val(id_recurso_sede);
    $('#precio_compra').val(recurso_sede_precio);
}

function agregar_stock_entrante(){
    var valor = true;
    var id_recurso = $('#id_recurso_sede_stock').val();
    var stock_entrante = $('#stock_entrante').val();
    var precio_compra = $('#precio_compra').val();
    if(valor) {
        var cadena = "id_recurso=" + id_recurso +
            "&stock_entrante=" + stock_entrante +
            "&precio_compra=" + precio_compra;
        $.ajax({
            type: "POST",
            url: urlweb + "api/Almacen/sumar_stock_nuevo",
            data: cadena,
            dataType: 'json',
            success: function (r) {
                switch (r.result.code) {
