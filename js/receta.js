...
function editar_detalle_receta(id_detalle_receta, id_receta ,id_recursos_sede,detalle_receta_unidad_medida, detalle_receta_cantidad, detalle_receta_precio, detalle_receta_estado) {
    ...
    $.ajax({
        ...
        success:function (r) {
            ...
            $('#detalle_receta_unidad_medida_e').val(detalle_receta_unidad_medida);
            console.log(detalle_receta_unidad_medida);
